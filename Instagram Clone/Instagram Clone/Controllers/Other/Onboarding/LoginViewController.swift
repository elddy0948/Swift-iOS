...
import SafariServices   // For WebView
import UIKit
...
class LoginViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        privacyButton.frame = CGRect(x: 10, y: view.height - view.safeAreaInsets.bottom - 50
                                     , width: view.width - 20, height: 50)
    ...
    private func configureHeaderView() {
        ...
        logoImage.frame = CGRect(x: headerView.width / 4, y: view.safeAreaInsets.top,
    ...
    @objc private func didTapTermsButton(){
        guard let url = URL(string: "https://help.instagram.com/581066165581870?%3F__hstc=259582869.99a265337744294b740e0787aea508c4.1580515200151.1580515200152.1580515200153.1&__hssc=259582869.1.1581292800142&__hsfp=1235564426&_ga=2.268372686.1304204721.1556549351-933118289.1529345498&helpref=page_content") else {
            return
        }
...
extension LoginViewController: UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        if textField == usernameEmailField {
            // usernameEmailField에서 리턴키를 누르면 passwordField를 가르키게 만든다.
            passwordField.becomeFirstResponder()
        } else if textField == passwordField {
            // passwordField에서 리턴키를 누르면 login버튼을 누른것으로 한다.
            didTapLoginButton()
        }
        return true
    }
